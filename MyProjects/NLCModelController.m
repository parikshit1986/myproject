...
@interface NLCModelController()
@property (readonly, strong, nonatomic) NSArray *pageData;
@end

@implementation NLCModelController
...
- (id)init
{
    ...
    if (self) {
        ...
        _pageData = @[ @"Stakeholders",@"Implications",@"Barriers"];
    }
    return self;
}
...
{   
    ...
    NLCDataViewController *dataViewController = [storyboard instantiateViewControllerWithIdentifier: _pageData[index]];
    dataViewController.dataObject=_pageData[index];
    
    dataViewController.project = _project;
...
{
    NSUInteger index = [self indexOfViewController:(NLCDataViewController *)viewController];
